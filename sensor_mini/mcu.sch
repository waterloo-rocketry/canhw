...
$EndDescr
$Comp
L sensors-rescue:MCP2562-canhw-sensors-rescue-sensors-rescue-sensors-rescue U?
U 1 1 5BB14883
P 8650 3850
AR Path="/5B9CFC89/5BB14883" Ref="U?"  Part="1" 
AR Path="/5B9D6FCC/5BB14883" Ref="U?"  Part="1" 
AR Path="/5BB12E21/5BB14883" Ref="U?"  Part="1" 
AR Path="/5BB1460E/5BB14883" Ref="U9"  Part="1" 
F 0 "U9" H 8625 4115 50  0000 C CNN
...
AR Path="/5BB1460E/5BB1488A" Ref="#PWR052"  Part="1" 
F 0 "#PWR052" H 8100 3600 50  0001 C CNN
...
AR Path="/5BB1460E/5BB148A5" Ref="#PWR045"  Part="1" 
F 0 "#PWR045" H 3700 2500 50  0001 C CNN
...
AR Path="/5BB1460E/5BB148D6" Ref="#PWR054"  Part="1" 
...
AR Path="/5BB1460E/5BB148EE" Ref="#PWR053"  Part="1" 
F 0 "#PWR053" H 8100 4300 50  0001 C CNN
...
AR Path="/5BB1460E/5BB1492B" Ref="#PWR050"  Part="1" 
F 0 "#PWR050" H 7600 2050 50  0001 C CNN
...
U 1 1 5BB0E97E
P 4550 6250
F 0 "#PWR047" H 4550 6000 50  0001 C CNN
...
U 1 1 5BB126F9
P 4650 4350
F 0 "#PWR048" H 4650 4100 50  0001 C CNN
...
U 1 1 5BBBA7AC
P 2600 4350
F 0 "R5" H 2668 4396 50  0000 L CNN
...
U 1 1 5BBBAE12
P 8100 2000
F 0 "C16" V 7848 2000 50  0000 C CNN
...
U 1 1 5BBBAFE7
P 8100 2500
F 0 "C17" V 7848 2500 50  0000 C CNN
...
U 1 1 5BBBB1DA
P 8100 4400
F 0 "C18" H 8215 4446 50  0000 L CNN
...
U 1 1 5BBC5D54
P 4500 4350
F 0 "C15" V 4248 4350 50  0000 C CNN
...
U 1 1 5BBCCFEA
P 5350 4150
F 0 "R6" H 5418 4196 50  0000 L CNN
...
$EndComp
$Comp
L canhw:PIC18F26K83 U8
U 1 1 5C610E8C
P 3650 5350
F 0 "U8" H 3625 6265 50  0000 C CNN
...
U 1 1 5CA0DA71
P 2300 5650
F 0 "R4" H 2368 5696 50  0000 L CNN
...
U 1 1 5CA0DAEE
P 2150 5650
F 0 "R3" H 2350 5700 50  0000 R CNN
...
AR Path="/5BB1460E/5EAD17DF" Ref="#PWR051"  Part="1" 
F 0 "#PWR051" H 7800 3600 50  0001 C CNN
...
AR Path="/5BB1460E/5EAD2CDD" Ref="#PWR044"  Part="1" 
...
AR Path="/5BB1460E/5EAD42E3" Ref="#PWR049"  Part="1" 
F 0 "#PWR049" H 5350 3850 50  0001 C CNN
...
AR Path="/5BB1460E/5EAD594D" Ref="#PWR046"  Part="1" 
...
AR Path="/5BB1460E/5EAD7107" Ref="#PWR043"  Part="1" 
F 0 "#PWR043" H 2600 4050 50  0001 C CNN
...
AR Path="/5BB1460E/5EAD87D4" Ref="#PWR042"  Part="1" 
