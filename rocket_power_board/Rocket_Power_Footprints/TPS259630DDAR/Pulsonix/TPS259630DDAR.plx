...
(library Library_1
	...
	(compDef "TPS259630DDAR" (originalName "TPS259630DDAR") (compHeader (numPins 9) (numParts 1) (refDesPrefix IC)
		...
		(compPin "2" (pinName "DVDT") (partNum 1) (symPinNum 2) (gateEq 0) (pinEq 0) (pinType Unknown))
		(compPin "3" (pinName "EN/UVLO") (partNum 1) (symPinNum 3) (gateEq 0) (pinEq 0) (pinType Unknown))
		...
		(compPin "8" (pinName "OVLO/OVCSEL") (partNum 1) (symPinNum 6) (gateEq 0) (pinEq 0) (pinType Unknown))
		(compPin "7" (pinName "ILM") (partNum 1) (symPinNum 7) (gateEq 0) (pinEq 0) (pinType Unknown))
		(compPin "6" (pinName "__FLT") (partNum 1) (symPinNum 8) (gateEq 0) (pinEq 0) (pinType Unknown))
		(compPin "5" (pinName "OUT") (partNum 1) (symPinNum 9) (gateEq 0) (pinEq 0) (pinType Unknown))
		...
		(attr "<Hyperlink>" "https://www.ti.com/lit/gpn/TPS2596")
		(attr "<Component Height>" "1.7")
		(attr "<STEP Filename>" "TPS259630DDAR.stp")
